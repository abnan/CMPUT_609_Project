...
f.write("Alternating sigma per step; lambda = 0.5"+',')
f.write(write_data+'\n')
#Plot all different lr for a fixed sigma
plt.plot(alphas, avg_reward_list, colours[colour_index], label = "Alternating sigma per step")
colour_index += 1
