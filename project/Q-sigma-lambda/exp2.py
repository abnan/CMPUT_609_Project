...
f.write("Exponentially increasing sigma e"+',')
f.write(write_data+'\n')
#Plot all different lr for a fixed sigma
plt.plot(alphas, avg_reward_list, colours[colour_index], label = "Exponentially increasing sigma e")
colour_index += 1
